...
class SocialsControllerTest < ActionController::TestCase
  ...
  test "should create social" do
    assert_difference('Social.count') do
      post :create, social: { active_date: @social.active_date, article_date: @social.article_date, author: @social.author, avatar: @social.avatar, description: @social.description, image_caption: @social.image_caption, permalink: @social.permalink, quote: @social.quote, shortlink: @social.shortlink, thumbnail: @social.thumbnail, title: @social.title, video: @social.video }
    end
  ...
  test "should update social" do
    patch :update, id: @social, social: { active_date: @social.active_date, article_date: @social.article_date, author: @social.author, avatar: @social.avatar, description: @social.description, image_caption: @social.image_caption, permalink: @social.permalink, quote: @social.quote, shortlink: @social.shortlink, thumbnail: @social.thumbnail, title: @social.title, video: @social.video }
    assert_redirected_to social_path(assigns(:social))
  end
