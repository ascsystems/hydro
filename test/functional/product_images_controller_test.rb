...
class ProductImagesControllerTest < ActionController::TestCase
  ...
  test "should create product_image" do
    assert_difference('ProductImage.count') do
      post :create, product_image: { name: @product_image.name, order_num: @product_image.order_num, product_id: @product_image.product_id }
    end
  ...
  test "should update product_image" do
    put :update, id: @product_image, product_image: { name: @product_image.name, order_num: @product_image.order_num, product_id: @product_image.product_id }
    assert_redirected_to product_image_path(assigns(:product_image))
  end
