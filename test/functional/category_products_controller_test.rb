...
class CategoryProductsControllerTest < ActionController::TestCase
  ...
  test "should create category_product" do
    assert_difference('CategoryProduct.count') do
      post :create, category_product: { category_id: @category_product.category_id, order_number: @category_product.order_number, product_id: @category_product.product_id }
    end
  ...
  test "should update category_product" do
    put :update, id: @category_product, category_product: { category_id: @category_product.category_id, order_number: @category_product.order_number, product_id: @category_product.product_id }
    assert_redirected_to category_product_path(assigns(:category_product))
  end
