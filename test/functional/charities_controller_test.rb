...
class CharitiesControllerTest < ActionController::TestCase
  ...
  test "should create charity" do
    assert_difference('Charity.count') do
      post :create, charity: { description: @charity.description, featured: @charity.featured, logo: @charity.logo, name: @charity.name }
    end
  ...
  test "should update charity" do
    put :update, id: @charity, charity: { description: @charity.description, featured: @charity.featured, logo: @charity.logo, name: @charity.name }
    assert_redirected_to charity_path(assigns(:charity))
  end
