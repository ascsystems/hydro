...
class OptionValuesControllerTest < ActionController::TestCase
  ...
  test "should create option_value" do
    assert_difference('OptionValue.count') do
      post :create, option_value: { name: @option_value.name, option_id: @option_value.option_id, order_num: @option_value.order_num, price: @option_value.price }
    end
  ...
  test "should update option_value" do
    put :update, id: @option_value, option_value: { name: @option_value.name, option_id: @option_value.option_id, order_num: @option_value.order_num, price: @option_value.price }
    assert_redirected_to option_value_path(assigns(:option_value))
  end
