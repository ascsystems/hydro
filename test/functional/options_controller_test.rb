...
class OptionsControllerTest < ActionController::TestCase
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post :create, option: { name: @option.name, order_num: @option.order_num, product_id: @option.product_id }
    end
  ...
  test "should update option" do
    put :update, id: @option, option: { name: @option.name, order_num: @option.order_num, product_id: @option.product_id }
    assert_redirected_to option_path(assigns(:option))
  end
