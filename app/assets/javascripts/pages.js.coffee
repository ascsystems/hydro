...
$j ->
	...
	$j('div.tech_number').hover(
		->
			...
			if(slide == 'number_1')
				$j("#tech_circle").css('background-image','url(/images/tech-circle-1.png)');
			else if(slide == 'number_2')
				$j("#tech_circle").css('background-image','url(/images/tech-circle-2.png)');
			else if(slide == 'number_3')
				$j("#tech_circle").css('background-image','url(/images/tech-circle-3.png)');
			else if(slide == 'number_4')
				$j(".main_content").css('background-image', 'url("/images/tech-overlay-4.png"), url("/images/tech-flask.png"), url("/images/tech-water.jpg")');
				$j(".main_content").css('background-position', '310px -26px, 310px -26px, left 76px');
			else if(slide == 'number_5' || slide == 'number_6')
				$j(".main_content").css('background-image', 'url("/images/tech-overlay-5.png"), url("/images/tech-flask.png"), url("/images/tech-water.jpg")');
				$j(".main_content").css('background-position', '310px -26px, 310px -26px, left 76px');
		->
			slide = $j(this).attr('slide')
	...
	if(window.location.pathname == '/pages/hydro-flask-technology')
		$j(['/images/tech-circle-3.png','/images/tech-circle-2.png','/images/tech-circle-1.png','/images/tech-overlay-5.png']).preload();
